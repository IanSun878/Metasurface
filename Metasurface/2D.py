...
def make_unit_cell_sim(a,b):
    sim = td.Simulation(
        ...
        sources=[plane_wave],
        monitors=[monitor_t,fieldmonitor_2],
        run_time=run_time,
...
for i, x in enumerate(r):
    for j, y in enumerate(r):
        pillar_geo = td.Box.from_bounds( rmin=(x - D_list[i%Number][0]/2, y - D_list[i%Number][1]/2, 0), rmax=(x + D_list[i%Number][0]/2,y + D_list[i%Number][1]/2, h))
...
sim = td.Simulation(
    ...
    monitors=[monitor_xz, monitor_far],
    run_time=run_time,
